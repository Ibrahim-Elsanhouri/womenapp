			...
			<div class="contact-grids">
				<div class="col-md-7 contact-form">
					<form action="" method="post">
						...
						<input type="submit" name="photo_btn" value="احجز الان">
          </form>
		  <?php 
if (isset($_POST['photo_btn'])){	
	...
	$date = $_POST['date'];
$photos = $_POST['photos'];
		$insert_studio_order = "insert into photo_order (photo_id ,event ,  mobile , time , date) values ('$photo_id','$photos','$mobile','$time','$date')";
		$run_insert_studio_order = mysqli_query($connection , $insert_studio_order);
		if ($run_insert_studio_order){
