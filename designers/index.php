...
<td align="center" colspan="2">تسجيل الدخول </td>
					...
					<tr>
						<td>رقم المصمم  </td>
                        <td>
                        <input type="text" name="arrange_id" id="">
                        </td>
					</tr>
                    <tr>
                    <td>Password</td>
...
$password = $_POST['password'];
     $check_admin ="select arrange_id , password   from arrange    where arrange_id='$arrange_id' and password='$password' ";
     ...
     if ($run_check_admin_count==1){
         $_SESSION['ibra']=$arrange_id;
         echo "<script>alert(' اهلا بك في قسم ادارة تطبيق نسائيات الخاص  بالمشاغل النسائية   ')</script>" ;
