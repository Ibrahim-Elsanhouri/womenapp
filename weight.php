...
<body>
    ...
    <!-- //banner -->
    <script type="text/javascript">
        function get_suitable_weight(){
        var weight =document.getElementById("w").value;
        var taller =document.getElementById("t").value;
        var sw = weight / ((taller/100)^2);
        if (sw < 18.5 ){
            window.alert("تصنيف وزنك نحيف جدا ");

        }else if (sw > 18.5 && sw < 24.9){
            window.alert("وزنك مثالي حافظ عليه ");
        }else if (sw > 24.9 && sw < 29.5){
          window.alert("انت تعاني من زيادة وزن طفيفة حاول ان تصل الوزن المثالي ");
        }else {
          window.alert("انت تعاني من السمنة");
		...
		<div class="container">
			<div class="contact-grids">
				<div class="col-md-7 contact-form">
					<form>
						<input type="text" id="w" placeholder="ادخل وزنك بوحدة الكيلو جرام " required="">
						<input type="text" id="t" placeholder="ادخل طولك بوحدة سم " required="">
						
<button onclick="get_suitable_weight()" >
    معادلة الوزن المثالي 
</button>    
</form>
