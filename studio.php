			...
			<div class="contact-grids">
				<div class="col-md-7 contact-form">
					<form action="studio.php" method="post">
                        <form method="get">
                        <select name="sec" onchange="this.form.submit" id="">
                    <?php 
global $connection;
$get_sector = "select * from sectors ";
$run_get_sector = mysqli_query($connection,$get_sector);
while ($sector_row = mysqli_fetch_array($run_get_sector)){
