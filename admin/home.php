            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <i class="fa fa-folder-open"></i><b>&nbsp;Hello ! </b>Welcome Back <b> Ibrahim </b>
 <i class="fa  fa-pencil"></i><b>&nbsp;2,000 </b>نظام ادارة تطبيق نسائيات 
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
...
?>   
                                                <tr>
                                                    ...
                                                    <td><a href="delete_query.php?query=<?php echo $query ?>"  class="btn btn-danger">Delete</a> </td>
                                                    </tr>
<?php } ?>
                                                <tr>
