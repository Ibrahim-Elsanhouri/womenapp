...
<td align="center" colspan="2">تسجيل الدخول </td>
					...
					<tr>
						<td>رقم منسق الافراح  </td>
                        <td>
                        <input type="text" name="cos_id" id="">
                        </td>
					</tr>
                    <tr>
                    <td>Password</td>
...
$password = $_POST['password'];
     $check_admin ="select cos_id , password   from cos    where cos_id='$cos_id' and password='$password' ";
