...
<td align="center" colspan="2">تسجيل الدخول </td>
					...
					<tr>
						<td>رقم المشغل  </td>
                        <td>
                        <input type="text" name="saloon_id" id="">
                        </td>
					</tr>
                    <tr>
                    <td>Password</td>
...
$password = $_POST['password'];
     $check_admin ="select saloon_id , password   from saloons    where saloon_id='$saloon_id' and password='$password' ";
